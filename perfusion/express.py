...
if __name__ == "__main__":
	...
	get_tissue_tac(s,mtts,bvs,t)

	
	pancreas=get_tissue_tac(s,mtts,bvs,t)
	...
	print get_tissue_tac(s,[30],[0.3],t)[0,:,0]
	
	plt.plot(t,get_tissue_tac(s,[x],[y],t)[0,:,0],color='green')
	plt.plot(t,get_tissue_tac(s,[x-1],[y+0.1],t)[0,:,0],color=(0,0.5,0))
	plt.plot(t,get_tissue_tac(s,[x+5],[y+0.1],t)[0,:,0],color=(0,0.5,0))
	"""
	...
	path_to4d=u'/home/denest/PERF_volumes/TEMNOSAGATYI  A.V. 02.04.1973/NII/FILTERED_4/Безымянная папка/4D00.nii'
	...
	nib.nifti1.save(nii_im, 
					u'/home/denest/PERF_volumes/TEMNOSAGATYI  A.V. 02.04.1973/NII/FILTERED_4/Безымянная папка/4D00_bf_map.nii' )
