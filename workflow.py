...
for pathfold, dirs, file_list in os.walk(INPUT_FOLDER):
    for file_name in file_list:
        if not os.path.exists(os.path.join(OUTPUT_FOLDER, '_'.join([file_name.split('.')[0], 'I40', 'G1.5.nii']))):
            ...
            crop_image(fpath, 84, 329, 160, 290, 1, 260,
                       '/home/denest/PERF_volumes/TEMNOSAGATYI  A.V. 02.04.1973/NII/20140508_100402GeneralBodyPerfusionCopiedTEMNOSAGATYIAV02041973s004a001_filtered/croped/')
